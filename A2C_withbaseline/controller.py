...
def plot_mean_rewards(ac_returns, a2c_returns, rule_based_returns, mean_number,smoothing_window):
    ...
    plt.plot(mean_axis, a2c_mean_reward, label='A2C(with optimal policy)', linewidth=1)
    plt.plot(mean_axis, rule_based_mean_reward, label='Rule-Based optimal policy', linewidth=1)
